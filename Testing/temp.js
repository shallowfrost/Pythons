// temp.js
import { dataMassExport } from '../assets/data/data.js';

const morph_price = dataMassExport.morph_price;
const morph_names = dataMassExport.morph_names.slice(0, morph_price.length);
const all_morphs = dataMassExport.all_morphs;
const listCommand = dataMassExport.listCommand; // Keep this line
const commandDescriptions = dataMassExport.commandDescriptions;
